...
<main>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="breadcrumb-content">
                        <h5 class="title">Détail de l'abonnement {{ $abonnement->label }}</h5>
                        <ul>
    ...
    <div class="feature-area pt-130 pb-50">
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-8 col-md-10">
                <div class="section-title mb-70 mb-xs-50">
                    <h3>Les activités inclus</h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div class="class-content-area pt-50 pb-50">
                    <div class="container">
                        <div class="row justify-content-center">
...
{{-- EMPLOI  --}}
<div class="schedule-area pt-50 pb-50">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
